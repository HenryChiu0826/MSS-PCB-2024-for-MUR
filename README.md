...
Main Shutdown System PCB for FSAE team MUR (Melbourne University Racing). Takes in fault signals (insulation monitoring device, battery management system, precharge discharge overcurrent) 
and evaluate fault conditions (brake system plausibility device) via standalone, nonprogrammable analog devices.

First PCB designed. It was manufactured via reflow soldering, and while all functions worked in testing, problems surfaced when operating continously for long periods of time due to 
